...
class OFP_Property_Commerce_Admin {
    ...
    public function render_offers(): void {
        ...
        <div class="wrap">
            ...
            <?php if ( empty( $offers ) ) : ?>
                <div class="notice notice-info"><p>No installment offers yet.</p></div>
            <?php else : ?>
                <table class="widefat striped">
                    ...
                    <?php foreach ( $offers as $offer ) : ?>
                        <tr>
                            ...
                            <td>
                                <strong><?php echo esc_html( $offer->buyer_name ); ?></strong><br>
                                <small><?php echo esc_html( $offer->buyer_phone ); ?></small>
                            </td>
                ...
                <table class="widefat striped">
                    ...
                    <?php foreach ( $purchases as $purchase ) : ?>
                        <tr>
                            ...
                            <td>
                                <strong><?php echo esc_html( $purchase->buyer_name ); ?></strong><br>
                                <small><?php echo esc_html( $purchase->buyer_phone ); ?></small>
                            </td>
